...
```{r, message=FALSE}
ggplot(data = average_flipper_length, aes(x = species, y = average_flipper, fill = species)) + # fill in the blanks
  
  geom_bar(stat = "identity") + # tells ggplot to use the actual y-values from your data, instead of counting the number of rows like a typical bar plot does
  theme() +
  # courd_flip() +
  theme(legend.position = "none")+
  labs(tile = "Title", subtitle = "subtitle", x ="", y="flippy")
...
ggplot(data = average_culmen_depth, aes(x = species, y = average_culmen_depth, fill = species)) + # fill in the blanks

...
serv_outcomes <- teds_d %>%
  ...
  summarise(
    ...
    percentage_no_use_completed = (total_no_use / total_completed) * 100
  )
# try to make a bar (visualization 1)
...
# Line chart to see relationship them (visualization 3)
...
# Using the facet to see each services more clearly
ggplot(both_outcomes,
       aes(x = los, y = percentage_no_use_completed, color = services_d)) +
  geom_line() +
  labs(title = "No Use at Discharge (of Completed) by LOS, colored by Service",

...
```{r}
teds_d %>% 
  tabyl(reason) # from janitor package 140 for -9
```
...
Create three basic visualizations using `ggplot2` and the variables you recoded above. Use bar plots are good idea.
